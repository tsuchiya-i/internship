...
$filename = 'mission_2-5_reset_Tsuchiya.txt'; //ファイルの名前変数を作成
$count_filename = 'mission_2-5_reset_count_Tsuchiya.txt'; //ファイルの名前変数を作成投稿数格納用
...
<form method="post" action="mission_2-5_reset.php">
